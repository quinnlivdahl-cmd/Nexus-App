...
- `NEXUS_ISSUE_TRANSITION.md` provides sequencing and migration context.
- `NEXUS_LOCAL_PLAYABLE_ALPHA.md` provides the current operational finish line and gate model.
- `docs/nexus-roadmap/ROADMAP.md` provides durable lane and vision evidence. It is not a task tracker or game-source authority.
