...
- Prompt packet: `docs/nexus-game-source/source/Art/Style Trials/ART-TRIAL-020 - Nexus-Art-Style-Trial-Prompt-Series.md`
- Output image folder: `docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/`
- Output index placeholder: `docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/README.md`
...
`docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/`
...
Mode owner: Art  
Target folder: `docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/`  
...
`docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/trial-01-master-style-grid-5x5.png`
...
`docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/trial-02-palette-attitude-grid-5x5.png`
...
`docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/trial-03-tacmap-focused-grid.png`
...
`docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/trial-04-character-focused-grid.png`
...
`docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/trial-05-object-and-ui-grid.png`
...
`docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/trial-06-selected-style-production-sheet.png`
...
1. Confirm this folder path is acceptable in the repo Golden Truth source.
2. Regenerate the source index with `corepack pnpm run source:index`.
3. Validate with `corepack pnpm run validate:workflow`.
4. Generate or manually save images into `docs/nexus-game-source/source/Art/Style Trials/outputs/2026-06-12/`.
