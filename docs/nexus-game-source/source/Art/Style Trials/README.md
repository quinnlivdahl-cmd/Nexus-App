...
metadata_notes: "Created to route non-canon style and palette trials inside the Art Golden Truth source. Needs Codex/local verification and source-index regeneration."
---
...
1. Regenerate the source index with `corepack pnpm run source:index`.
