---
project: "Nexus"
doc_id: "PLAYAID-OPEN-009"
legacy_ids:
  - 'SRC-AUX-009'
legacy_paths:
  - 'C:\Users\Quintin Livdahl\Nexus\Nexus\99 Archive\01 Superseded Source\00 Source Slots 2026-06-10\15 Auxiliary Play Aids rev0.2\SRC-AUX-009 - Auxiliary_Play_Aids_Open_Questions.md'
title: "Auxiliary_Play_Aids_Open_Questions"
...
topic_family: "auxiliary_play_aids_open_questions"
owns_topics:
...
## 2. Deferred template work

Potential `Modes` template tasks:

- Encounter Start Packet template.
...
- The uploaded 64-node asteroid mine TacMap prototype is useful visual evidence but not canonical structured map data.
- The SVG starter kit should be preserved as asset evidence, but `Play Aids` should not absorb raw assets as source truth.
- Display aid polish should not outrun approved source content.
- Obsidian view-mode behavior must be tested for dashboards and handouts.

## 5. Parking lot

- Should hidden/DM-only layers be represented as separate files, callouts, Canvas layers, or renderer layers?
