---
project: "Nexus"
doc_id: "LORE-SETTING-001"
legacy_ids:
  - 'SRC-LORE-002'
legacy_paths:
  - 'C:\Users\Quintin Livdahl\Nexus\Nexus\99 Archive\01 Superseded Source\00 Source Slots 2026-06-10\12 Source Lore Factions Timeline rev0.2\SRC-LORE-002 - Setting_Overview_and_Themes.md'
title: "Setting_Overview_and_Themes"
...
topic_family: "setting_overview_and_themes"
owns_topics:
  - 'setting_overview_and_themes'
borrows_topics: []
created: "2026-05-14"
last_updated: "2026-06-08"
last_reviewed: "2026-06-08"
metadata_verified: true
metadata_notes: "Phase 9 normalized doc_id and placement metadata from LORE-CORE-002 to LORE-SETTING-001. Phase 10 consolidated body routing into domain-first language and preserved the active setting frame without relying on slot-era wording."
---
...
The setting is at the brink of contact, not after clean first contact.

> First contact has not happened. The solar system has only received enough evidence to ruin itself guessing.
...
- Drone Wars / WW3 and the loss of the old state monopoly on force.
- Climate worsening and Earth disarray.
- Corporate-government sovereignty and first corporate citizens.
- Commercial brain augmentation pressure.
- Personhood wars over bodies, minds, uploads, implants, splicers, AI, and legal identity.
- C-POH / human-continuity backlash.
- Implant-network phenomena associated with the Choir.
- Upload confirmation, server-polity emergence, and fear of copied persons.
...
- labor status, ownership, contract, and assigned function;
- infrastructure compatibility and Standard Fit assumptions;
- caste/class perception and elite recognition;
- medical access, suit access, crash couches, restraints, doors, clinics, and emergency systems;
- technological dependency, hack surface, maintenance burden, and institutional control.
