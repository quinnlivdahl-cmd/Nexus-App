---
project: "Nexus"
doc_id: "LORE-LOCATION-001"
legacy_ids:
  - 'SRC-LORE-005'
legacy_paths:
  - 'C:\Users\Quintin Livdahl\Nexus\Nexus\99 Archive\01 Superseded Source\00 Source Slots 2026-06-10\12 Source Lore Factions Timeline rev0.2\SRC-LORE-005 - Locations_Solar_System_and_Travel.md'
title: "Locations_Solar_System_and_Travel"
...
topic_family: "locations_solar_system_and_travel"
owns_topics:
...
metadata_notes: "Phase 9 normalized doc_id and placement metadata from LORE-CORE-005 to LORE-LOCATION-001. Phase 10 consolidated body routing into domain-first language, repaired inherited display corruption, and preserved the active location frame without relying on slot-era wording."
---
...
1. Solar-system regions and route bands.
2. Major centers such as Earth, Earth orbit, Mars, Jupiter-space, and the Belt/frontier.
3. Stations, habitats, moons, corporate sites, shipyards, mines, server habitats, clinics, and route nodes.
4. Mission locations and TacMaps.
...
Earth should feel engineered, scarred, defended, overgoverned, historically loaded, and politically important.

### Earth orbit

Earth orbit is crowded, regulated, habitat-dense, strategically sensitive, and legally watched. It likely has strong Treaty/System Authority presence and strong C-POH influence, but also corporate, shipping, station, and diplomatic complexity.
...
Useful location pressures to preserve:

- low-G habitats and adapted-human communities;
- asteroid mines and brittle industrial settlements;
- long-flight habitats and outer-system route cultures;
- pressure-suit and crash-couch compatibility;
- medical and emergency systems built around baseline/Standard Fit assumptions;
- splicer accommodation fights around seats, doors, restraints, clinics, airlocks, and work assignments.

Lizard people's long-spaceflight origin may belong in outer-system or long-route location history, but the full biological profile should remain in the origin and splicer branch until better developed.
