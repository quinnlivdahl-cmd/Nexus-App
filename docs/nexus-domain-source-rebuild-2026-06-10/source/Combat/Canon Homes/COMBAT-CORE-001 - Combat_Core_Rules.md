...
legacy_ids:
  - 'SRC-COMBAT-002'
legacy_paths:
  - 'C:\Nexus Mother Folder\00 Nexus Obsidian Vault\00 Source\08 Source Combat TacMaps Encounters rev0.4\SRC-COMBAT-002 - Combat_Core_Rules.md'
...
metadata_notes: "Pilot migration into the domain-first rebuild repo. Phase 10 consolidated body routing into domain-first language and preserved the active combat core without relying on package-era framing."
---
