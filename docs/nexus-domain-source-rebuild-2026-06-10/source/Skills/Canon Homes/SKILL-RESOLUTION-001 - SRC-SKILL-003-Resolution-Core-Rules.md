...
legacy_ids:
  - 'SRC-SKILL-003'
legacy_paths:
  - 'C:\Nexus Mother Folder\00 Nexus Obsidian Vault\00 Source\10 Skills Resolution RNG rev0.5\SRC-SKILL-003 - Resolution_Core_Rules.md'
...
4. DM identifies the check type, relevant capability, difficulty/defense, stakes, and modifier lanes.
