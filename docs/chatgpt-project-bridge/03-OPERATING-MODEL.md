...
| App repo | App implementation, repo workflow files, bridge files, validation scripts | Live source authority |
...
| Codex/local | Inspection, implementation, validation, bridge updates, issue evidence | Human approval for uploads or source promotions |
...
3. Update the smallest bridge file or packet that solves the context gap.
