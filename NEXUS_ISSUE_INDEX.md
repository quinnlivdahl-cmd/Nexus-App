...
|---|---|---|---|---|
| #110–#125 except #112 | Remaining Integration Contract implementation sequence | Native predecessor issues remain open | GitHub native dependency graph after #108 | Leave blocked children unassigned and without `status:ready-for-agent`; promote only the cleared frontier |
