...
`.agents/plans/DM_Context_Broker_Contract_rev0.1.md`
...
Issue #41 suggested `.agents/plans/` as a possible repo lane. This draft uses `.agents/plans/` as the issue-specific plan/contract lane.
